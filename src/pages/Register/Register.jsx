                    ...
                    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleRegister} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input type="email"
                                    name="email" placeholder="Enter your email address" className="input input-bordered" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                        ...
                        <p className="text-center mt-4">Already have an account? <Link className="link link-hover text-blue-600" to='/login'>Login now!</Link></p>
                    </div>
                </div>
            </div>
        </div>
